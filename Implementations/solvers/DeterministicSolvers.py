...
'''
def RHS_H(t:float,state:NDArray[np.float_],param:Dict[str,float])->NDArray[np.float_]:
...
def Jacobian(t:float,state:NDArray[np.float_],par:Dict[str,float])->NDArray[np.float_]:
...
def RHS_SEIARHD(t:float,state:NDArray[np.float_],param:Dict[str,float])->NDArray[np.float_]:
    """Integator for the SIRH model from Alex's SDH project.
...
class EulerSolver(Integrator): 
    ...
    def RHS_H(self,state:NDArray[np.int_],param:Dict[str,int])->NDArray[np.float_]:
...
class EulerSolver_SIR(Integrator): 
    ...
    def RHS(self,state:NDArray[np.float_],param:Dict[str,float])->NDArray[np.float_]:
