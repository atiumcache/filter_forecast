...
def likelihood_NB_R(observation:NDArray[np.int_],particle_observation:NDArray[np.int_],R:float)->NDArray[np.float_]: 
...
def likelihood_poisson(observation:NDArray[np.int_],particle_observation:NDArray[np.int_],var:float)->NDArray[np.float_]:
